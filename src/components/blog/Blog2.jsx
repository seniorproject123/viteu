          ...
          <main className="bg-white pb-16 pt-8 antialiased lg:pb-24 lg:pt-16 dark:bg-gray-900">
            <div className="left-between mx-auto flex max-w-screen-xl px-4 ">
              <article className="format format-sm sm:format-base lg:format-lg format-blue dark:format-invert mx-auto w-full max-w-2xl">
                ...
                <p className=" mb-3 text-left text-gray-500 dark:text-gray-400">
                  La technologie ne se limite pas à la phase de recherche,{" "}
                  <strong>
                    elle redéfinit également les interactions humaines.
                  </strong>{" "}
                  Des fonctionnalités novatrices telles que la messagerie
                ...
                <p className=" mb-3 text-left text-gray-500 dark:text-gray-400">
                  ...
                  essentiel de{" "}
                  <strong>
                    préserver la confidentialité de vos informations
                    personnelles et de rester attentif aux signes de
                    comportements suspects.
                  </strong>{" "}
                  Lorsque vous décidez de rencontrer quelqu'un en personne,
                  optez toujours pour des lieux publics et assurez-vous de
                  partager vos plans avec un proche. Ces précautions, bien que
                  nécessaires, peuvent néanmoins susciter des inquiétudes quant
                  à la sûreté de nos interactions en ligne.
                </p>
                <p className=" mb-3 text-left text-gray-500 dark:text-gray-400">
