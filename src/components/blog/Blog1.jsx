            ...
            <div className="left-between mx-auto flex max-w-screen-xl px-4">
              <article className="format format-sm sm:format-base lg:format-lg format-blue dark:format-invert mx-auto w-full max-w-2xl">
                ...
                <p className="mb-3 text-left text-gray-500 dark:text-gray-400">
                  ...
                  Optez pour un apéro dans un bar à thème ou une activité hors
                  du commun pour briser la glace. Mais surtout, écoutez votre
                  intuition et adaptez-vous à votre ressenti. Rappelez-vous, le
                  premier rendez-vous ne vous engage à rien. N'hésitez donc pas
                  à multiplier les rencontres de manière raisonnable. Au cours
                  de ces échanges, vous découvrirez rapidement si le courant
                  passe. Et si ce n'est pas le cas, ne craignez pas de mettre
                  fin à la soirée poliment mais fermement.
                </p>
                <p className="mb-3 text-left text-gray-500 dark:text-gray-400">
                ...
                <p className="mb-3 text-left text-gray-500 dark:text-gray-400">
                  En fin de compte,{" "}
                  <strong>
                    rappelez-vous que le dating est avant tout une aventure.
                  </strong>{" "}
                  Gardez l'esprit ouvert, restez authentique et surtout,
                  profitez du voyage. Qui sait quelles merveilles vous réserve
