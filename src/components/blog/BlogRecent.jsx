    ...
    >
      <div className="mx-auto max-w-screen-xl px-4">
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <Link onClick={scrollToTop} to="/les-regles-de-l-art-du-dating">
          ...
          <Link
            onClick={scrollToTop}
            to="/le-role-de-la-technologie-dans-les-rencontres-modernes"
          >
            <article className="max-w-xs">
              <a href="">
          ...
          <Link onClick={scrollToTop} to="/le-secret-des-rencontres-estivales">
            <article className="max-w-xs">
              <img
                src={ImgBlog3}
          ...
          <Link
            onClick={scrollToTop}
            to="/nos-conseils-d-experts-pour-un-rendez-vous-amoureux-reussi"
          >
            <article className="max-w-xs">
              <img
                src={ImgBlog4}
