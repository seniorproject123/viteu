          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <table className="mt-4 table-auto border-collapse  shadow-lg">
              ...
              <tbody className="text-gray-900 dark:text-white">
                <tr>
                  <td className="border px-8 py-4">Rencontres 30-45 ans</td>
                  <td className="border px-8 py-4">Janvier 2025</td>
                </tr>
                <tr>
                  <td className="border px-8 py-4">Rencontres 45-55+ ans</td>
                  <td className="border px-8 py-4">Janvier 2025</td>
                </tr>
              </tbody>
            </table>
